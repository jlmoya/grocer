function res=olsarma(grocer_AR,grocer_MA,grocer_namey,varargin)
...
res=olsarma1(y,x,grocer_AR,grocer_MA,grocer_initown,grocer_beta,grocer_optfunc,grocer_opt_optim)
