function [listendo_eq,indendo_eq,ind_endo_eq,ind_exo_eq,ind_resid_eq,listexo_eq,listresid_eq,coeffs_eq,listeqperendo,listeqperexo,listeqperresid,listeqpercoeff,listeqperparam,namexo,typevari,lags_exos]=check_variables_ineq2(variable,name_eq,indeq,listendo_eq,indendo_eq,listexo_eq,listresid_eq,coeffs_eq,listeqperendo,listeqperexo,listeqperresid,listeqpercoeff,listeqperparam,namendo,namexo,nameresid,namecoeff,nameparam,lags_exos)
...
//   in the model
// * nameparam = a string vector, the names of the ceofficients
//   in the model
...
if isnum(variable) then
   ...
   if ~isempty(ind_endo_eq) then
      ...
      if ~isempty(ind_resid_eq) then
         typevari= 'resid'
         listresid_eq=[listresid_eq ; variable]
...
//              param_eq=[param_eq ; variable]
               ...
               listexo_eq=[listexo_eq ; variable]
            end
         end
      end
   end
