function []=prt_panel_cce(res,out)
...
write(out,' ')
if and(meth ~= ['CCEMG'; 'CCEP';'dynamic CCEMG';'jackknife dynamic CCEMG']) then
   error('arg 1 is not results panel with common correlated effects')
end
