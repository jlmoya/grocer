function [tsmat1]=%tsmat_s_ts(tsmat1,ts2)
 
// PURPOSE: substracts a timeseries to a tsmat;
// the overloading capability of scilab allows then one to
// write tsmat-ts to do the subtraction
// ------------------------------------------------------------
// INPUT:
...
// ------------------------------------------------------------
// OUTPUT:
// * tsmat1 = the subtraction of a timeseries to a tsmat
// ------------------------------------------------------------
// NOTES:
// ------------------------------------------------------------
