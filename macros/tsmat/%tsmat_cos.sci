function tsmat=%tsmat_cos(tsmat)
 
// PURPOSE: define the cosine of a tsmat;
// the overloading capability of scilab allows then one to write
// cos(tsmat) to take the cosine of a tsmat
// ------------------------------------------------------------
// INPUT:
