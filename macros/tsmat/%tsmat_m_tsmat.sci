function [tsmat1]=%tsmat_m_tsmat(tsmat1,tsmat2)
 
// PURPOSE: operates the elementwise product of 2 tsmat;
// the overloading capability of scilab allows then one to write
// tsmat1*tsmat2 to do the product
// ------------------------------------------------------------
// INPUT:
...
// ------------------------------------------------------------
// OUTPUT:
// * tsmat1 = the product of the 2 tsmat
// ------------------------------------------------------------
// NOTES:
// ------------------------------------------------------------
