function tsmat=%tsmat_ceil(tsmat)
 
// PURPOSE: define the rounded up value of a tsmat;
// the overloading capability of scilab allows then one to write
// ceil(tsmat) to take the rounded up value of a tsmat
// ------------------------------------------------------------
// INPUT:
...
tsmat('series')=ceil(tsmat('series'))
