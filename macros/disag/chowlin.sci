...
// ------------------------------------------------------------
// REFERENCE: Chow, G. & Lin, A.L. (1971) "Best linear unbiased
...
[y,res]=chowlin1(Y,x,grocer_ta,grocer_divfq,grocer_delta,grocer_typemin,grocer_optfunc,grocer_opt_optim)
