function [xlag]=mlagb(x,n,init)
 
// PURPOSE: generates a matrix of n lags from a matrix (or
...
// ------------------------------------------------------------
// NOTES:
// see also mlag() which works more conventionally
// ------------------------------------------------------------
...
for j = 1:n
   for i = 1:nvar
      xlag(j+1:nobs,icnt+i) = x(1:nobs-j,i);
   end
   icnt = icnt+nvar;
end
