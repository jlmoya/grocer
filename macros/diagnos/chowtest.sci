function [resulch]=chowtest(resulols,n1,np)
 
// PURPOSE: provides the classical Chow test
// ------------------------------------------------------------
// INPUT:
// * resulols = results tlist from a first stage estimation
// * n1 = # of observations of the first sub-period
// * np = 'noprin' if the user does not want to display the
//   results
// ------------------------------------------------------------
// OUPTUT:
...
[fstat,f_pvalue,dfnum,dfden]=chowtest0(resulols,n1)
resulch=tlist(['results';'meth';'rols';'f';'dfnum';...
'dfden';'f_pvalue';'cut'],..
'chowtest',resulols,fstat,dfnum,dfden,...
f_pvalue,dat1)
