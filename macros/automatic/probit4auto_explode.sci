function [grocer_opt,y,namey,x,namexos,z,namecomp,prests,boundsvarb,nonna,multitest,testfunc,m2prt_test,nz,list_func,list_vararg]=probit4auto_explode(grocer_namey,varargin)
...
'depth';'wreliab';'dropna';'prt';'saturate';'saturate_post';...
'block search';'thresh_block';'block_nmax'],...
'liberal',5,'bic',[],...
[],[],[],[],[],[],emptystr(),...
...
testfunc=test_empty
m2prt_test=[]
list_func=list(probit4auto_part,probit4auto_upd,probit4auto_full)
list_vararg=list()
