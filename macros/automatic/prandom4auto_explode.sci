function [grocer_opt,grocer_y,grocer_namey,grocer_x,grocer_namexos,grocer_z,grocer_namecomp,prests,boundsvarb,nonna,multitest,testfunc,m2prt_test,nz,list_func,output_list]=prandom4auto_explode(grocer_namey,varargin)
...
// of the names in the database
            ...
            elseif grocer_nameopt == 'glsmeth' then
               grocer_glsmeth=part(argi,9:length(argi))
   ...
   for grocer_i=grocer_nargin:-1:2
      ...
      elseif grocer_nameopt == 'defname' then
   ...
   [grocer_mats,grocer_names,prests,boundsvarb,nonna]=explon(list(grocer_namey,grocer_comp,grocer_lx),...
...
testfunc=test_empty
m2prt_test=[]
nz=1+size(grocer_z,2)
list_func=list(prandom4auto_part,prandom4auto_upd,prandom4auto_full)
output_list=list(grocer_glsmeth,grocer_id,grocer_nameid)
