function rpanel=pfixedhac4auto_full(y,x,z,namey,namexos,namecomp,prests,boundsvar,dropna,ncomp,list_vararg)
...
rpanel = pfixed_hac1(y,index,[z ,x],typvcv,win)
...
rpanel('namex') = [ grocer_nameid ; namexos ]
rpanel('namey') = namey
