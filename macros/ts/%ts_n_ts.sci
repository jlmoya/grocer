function [ts1]=%ts_n_ts(ts1,ts2)
 
// PURPOSE: returns the ts equal to 0 over the dates where two
// ts are equal and 1 over the ones where they are different
// ------------------------------------------------------------
// INPUT:
// * ts1 = a time series
// * ts2 = a time series
// ------------------------------------------------------------
// OUTPUT:
// * ts1 = the (0,1) resulting time series
// ------------------------------------------------------------
// NOTES:
// ------------------------------------------------------------
...
ts1('series')=bool2s(s1(datfirst-d1f+1:datlast-d1f+1)...
