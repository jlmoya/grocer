function [grocer_x0,grocer_f0,grocer_maxf0]=newton_GGN11_sp(grocer_x0,grocer_func,grocer_Jac,grocer_indJac,grocer_ftol,grocer_itermax,grocer_alphamin)
...
while grocer_maxf0 > grocer_ftol & grocer_decreasing & grocer_iter < grocer_itermax
   ...
   grocer_IJ0_f0=lusolve(sparse(grocer_indJac,grocer_Jac(grocer_x0)),grocer_f0);
 
   try
      grocer_y1=grocer_x0-grocer_IJ0_f0;
      grocer_hand1=lufact(sparse(grocer_indJac,grocer_Jac(grocer_y1)))
      grocer_IJy1_f0=lusolve(grocer_hand1,grocer_f0);
      ...
      // stop here the process since convergence has been achieved
         ...
         grocer_IJy1_f1=lusolve(grocer_hand1,grocer_fz1);
