function [grocer_x0,grocer_f0,grocer_maxf0]=newton_XY16_sp(grocer_x0,grocer_func,grocer_Jac,grocer_indJac,grocer_ftol,grocer_itermax,grocer_alphamin)
 
// PURPOSE: find the 0 of an equation using the variant of the
// Newton method provided by X. Y. Xiao and H. W. Yin,
// “Increasing the order of convergence for iterative methods
// to solve nonlinear systems,” Calcolo. A, Quarterly on
// Numerical Analysis and Theory of Computation, vol. 53,
//  no. 3, pp. 285–300, 2016.
...
while grocer_maxf0 > grocer_ftol & grocer_decreasing & grocer_iter < grocer_itermax
   ...
   grocer_hand0=lufact(sparse(grocer_indJac,grocer_Jac(grocer_x0)))
   grocer_IJ0_f0=lusolve(grocer_hand0,grocer_f0);
   try
      grocer_y1=grocer_x0+grocer_IJ0_f0;
      grocer_Jy1=sparse(grocer_indJac,grocer_Jac(grocer_y1));
      grocer_fy1=grocer_func(grocer_y1)
      grocer_z1=grocer_y1-lusolve(grocer_hand0,grocer_fy1);
      ...
      // stop here the process since convergence has been achieved
         ...
         grocer_x1=grocer_z1+lusolve(grocer_Jy1,grocer_fz1)-2*lusolve(grocer_hand0,grocer_fz1);
