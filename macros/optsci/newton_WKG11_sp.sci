function [grocer_x0,grocer_f0,grocer_maxf0]=newton_WKG11_sp(grocer_x0,grocer_func,grocer_Jac,grocer_indJac,grocer_ftol,grocer_itermax,grocer_alphamin)
 
// PURPOSE: find the 0 of an equation using the variant of the
// Newton method provided by X. Wang, J. Kou and C. Gu( 2011),
// Semilocal convergence of a sixth-order Jarrat method
// in Banach spaces, Numer. Algorithms, 57, 441–456.
...
// * grocer_indJac = a (K x 2) matrix, colelcting the non zero
...
while grocer_maxf0 > grocer_ftol & grocer_decreasing & grocer_iter < grocer_itermax
   ...
   grocer_IJ0_f0=lusolve(grocer_J0,grocer_f0);
   try
      grocer_y1=grocer_x0-2/3*grocer_IJ0_f0;
      grocer_v1=grocer_Jac(grocer_y1)
      grocer_Jy1=sparse(grocer_indJac,grocer_v1);
 
      grocer_z1=grocer_x0-lusolve(6*grocer_Jy1-2*grocer_J0,(3*grocer_Jy1+grocer_J0)*grocer_IJ0_f0);
      grocer_fz1=grocer_func(grocer_z1)
      grocer_maxfz1=max(grocer_fz1)
      ...
      // stop here the process since convergence has been achieved
         ...
         grocer_x1=grocer_z1-1.5*lusolve(grocer_Jy1+0.5*grocer_J0,grocer_fz1);
         grocer_f1=grocer_func(grocer_x1)
         grocer_maxf1=max(abs(grocer_f01))
         ...
         elseif grocer_maxfz1 < grocer_maxf0 then
            ...
            grocer_f1=grocer_func(grocer_y1)
      ...
      while grocer_alpha > grocer_alphamin
         try
            ...
            grocer_f0=grocer_func(grocer_x1)
            grocer_alpha=grocer_alphamin
         catch
            grocer_alpha=grocer_alpha/2
         end
      end
      if grocer_alpha <= grocer_alphamin
         warning('grocer_alpha <= grocer_alphamin: cannot improve convergence ')
      end
      grocer_maxf0=max(abs(grocer_f0))
      grocer_x0=grocer_x1
