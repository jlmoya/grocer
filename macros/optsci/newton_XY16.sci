function [grocer_x0,grocer_f0,grocer_maxf0]=newton_XY16(grocer_x0,grocer_func,grocer_Jac,grocer_ftol,grocer_itermax,grocer_alphamin)
...
while grocer_maxf0 > grocer_ftol & grocer_decreasing & grocer_iter < grocer_itermax
   ...
   try
      ...
      grocer_z1=grocer_y1-grocer_IJ0*grocer_fy1;
      ...
      // stop here the process since convergence has been achieved
         ...
         grocer_x1=grocer_z1+(inv(grocer_Jy1)-2*grocer_IJ0)*grocer_fz1;
