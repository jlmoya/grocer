function [grocer_x0,grocer_f0,grocer_maxf0]=newton_WKG11(grocer_x0,grocer_func,grocer_Jac,grocer_ftol,grocer_itermax,grocer_alphamin)
...
// * grocer_Jac = a function, perfroming the Jacobian of the
//   function
...
while grocer_maxf0 > grocer_ftol & grocer_decreasing & grocer_iter < grocer_itermax
   ...
   grocer_IJ0=inv(grocer_J0)
   grocer_IJ0_f0=grocer_IJ0*grocer_f0;
   try
      grocer_y1=grocer_x0-2/3*grocer_IJ0_f0;
      grocer_Jy1=grocer_Jac(grocer_y1)
 
      grocer_z1=grocer_x0-inv(6*grocer_Jy1-2*grocer_J0)*(3*grocer_Jy1+grocer_J0)*grocer_IJ0_f0;
      ...
      // stop here the process since convergence has been achieved
         ...
         grocer_x1=grocer_z1-(1.5*inv(grocer_Jy1)-0.5*grocer_IJ0)*grocer_fz1;
