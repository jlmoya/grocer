function [grocer_x0,grocer_f0,grocer_maxf0]=newton_U15(grocer_x0,grocer_func,grocer_Jac,grocer_ftol,grocer_itermax,grocer_alphamin)
...
while grocer_maxf0 > grocer_ftol & grocer_decreasing & grocer_iter < grocer_itermax
   ...
   grocer_J1=grocer_Jac(grocer_y1)
   grocer_J2=3*grocer_J1-grocer_J0
   grocer_J3=3*grocer_J1+grocer_J0
   grocer_IJ2=inv(grocer_J2)
 
   try
      grocer_z1=grocer_x0-0.5*grocer_IJ2*grocer_J3*grocer_IJ0_f0
      ...
      if grocer_maxf1 < grocer_ftol then
         ...
         grocer_w1=grocer_z1-2*grocer_IJ2*grocer_fz1
         ...
         if grocer_maxf1 < grocer_ftol then
            ...
            grocer_x1=grocer_w1-2*grocer_IJ2*grocer_fw1
